...
export default function FAQ() {
  ...
  return (
    <div className="bg-white py-9 px-3 max-w-[1440px] mx-auto  hidden md:flex flex-col">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-4">
          Frequently Asked Questions
        </h2>

        <p className="text-center text-[#000000B2] max-w-xl mx-auto mb-12">
        ...
        <div className="space-y-4 max-w-[1230px] mx-auto">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                ...
                className={`rounded-2xl transition-all  duration-300 ${
                  isOpen ? "bg-[#DEDEF2]" : "bg-white"
                }`}
              >
                <button
                  onClick={() => toggle(index)}
                  aria-expanded={isOpen}
                  className="w-full flex justify-between items-center font-semibold p-6 text-left"
                >
